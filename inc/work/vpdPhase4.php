    ...
    <article class="article-container">
    	<section class="left-col group">
        	<div class="row1">
                ...
                <p><b>Back-end hub</b> - Sandra can view all of her pages and access them from here.</p>
            </div>
            <div class="row2">
                <img src="img/vpd-home-old.jpg">
                <p><b>Detailed Page</b> - Here Sandra can see all of the elements of her page and edit them in detail.</p>
            </div>
        </section>
